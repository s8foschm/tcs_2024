...
\usepackage{caption}
% Redefine the caption format to remove "Algorithm n:"
\DeclareCaptionFormat{myalgformat}{#3} % Only include the caption text
\captionsetup[algorithm]{format=myalgformat,labelsep=none}
...
\newcommand{\sheet}[2]{
\pagestyle{fancy}
\fancyhead[L]{Introduction to Theoretical Computer Science WS2024/25\\Exercise Sheet #1\\#2}
